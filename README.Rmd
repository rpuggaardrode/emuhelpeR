...
Another function provided by the package is `praatsauce2ssff()`,
...
but should in principle also work for output from [VoiceSauce](http://www.phonetics.ucla.edu/voicesauce/).
